...
void setup() {
  ...
  Serial.begin(57600);
  Serial.println("Scrolling buttons demo");
  Serial.println();
...
void loop() {
  ...
  if(check_button(BTN1_PIN)) {
    Serial.println("Button 1 pressed");
    strcpy_P(display_string, btn1_text); 
    pressed = true;  
  }  
  if(check_button(BTN2_PIN)) {
    Serial.println("Button 2 pressed");
    strcpy_P(display_string, btn2_text);
    pressed = true;    
  }
  
  // If a button has been pressed, start displaying the text
  if(pressed) {
